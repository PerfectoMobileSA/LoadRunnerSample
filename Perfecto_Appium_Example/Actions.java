...
public class Actions
{
	...
	public int action() throws Throwable {
        ...
        try {
        	lr.start_transaction("Navigate to Google"); //Creates a transaction in loadrunner
        	navigateToPage(driver,"https://www.google.com");
        	lr.end_transaction("Navigate to Google", lr.AUTO); //Match this with the start_transaction
        	
        	lr.start_transaction("Search Perfecto");
    		setText(driver, By.name("q"), "perfecto");
    		lr.end_transaction("Search Perfecto", lr.AUTO);
    		
    		lr.start_transaction("Search Codeless");
    		setText(driver, By.name("q"), "sauce");
    		lr.end_transaction("Search Codeless", lr.AUTO);
    		
    		lr.start_transaction("Search Selenium");
    		setText(driver, By.name("q"), "Selenium");
    		lr.end_transaction("Search Selenium", lr.AUTO);
    		
    		lr.start_transaction("Search Appium");
    		setText(driver, By.name("q"), "Appium");
    		lr.end_transaction("Search Appium", lr.AUTO);
    		
    		lr.start_transaction("Search Automation");
    		setText(driver, By.name("q"), "Automation");
    		lr.end_transaction("Search Automation", lr.AUTO);
        	
    		//uxTimer(driver, "automation"); //uxTimer can also be used if you are leveraging Perfecto's uxTimer
